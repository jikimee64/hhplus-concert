...
sequenceDiagram
    ...
    대기열 -->> 날짜: 대기열 상태값 조회
    alt
        날짜 -->> 사용자: 대기열 만료시간이 지났을 경우 대기열 상태 값을 EXPIRED로 업데이트 후 에러 응답
    else
...
sequenceDiagram
    ...
    대기열 -->> 좌석: 대기열 상태값 반환
    alt
        좌석 -->> 사용자: 대기열 만료시간이 지났을 경우 대기열 상태 값을 EXPIRED로 업데이트 후 에러 응답
    else
...
sequenceDiagram
    ...
    대기열 -->> 결제: 대기열 상태값 반환
    alt
        결제 -->> 사용자: 대기열 만료시간이 지났을 경우 대기열 상태 값을 EXPIRED로 업데이트 후 에러 응답
    else
